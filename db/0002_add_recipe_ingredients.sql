...
(
    recipe_id uuid NOT NULL CONSTRAINT recipe_ingredient_recipe_fk REFERENCES recipes(id),
    ingredient_id uuid NOT NULL CONSTRAINT recipe_ingredient_ingredient_fk REFERENCES ingredients(id),
